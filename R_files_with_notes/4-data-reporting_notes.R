...
# * My botanist friend who reviewed these notes for me before the course would like me to inform
# you that, despite what the dataset suggests, irises do not have petals or sepals, instead having
# things that defy categorisation, known as "tepals".  It's not of particular consequence to these
# exercises, but she's very passionate about this.


#4.2 (Optional) R Markdown
